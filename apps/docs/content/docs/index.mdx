...
<Cards>
  ...
  <Card title="Authentication" href="/docs/auth/overview" description="Better Auth semantics in standalone Go, mounted first-class on Brick" />
  <Card title="Hooks" href="/docs/core/hooks" description="Before/After + Validate inside the write transaction" />
  <Card title="Schema DSL" href="/docs/schema/dsl" description="Define resources in typed Go, generate db/crud code" />
  ...
  <Card title="Deploy to Vercel" href="/docs/deployment/vercel" description="Serverless entrypoints, pooled Postgres, PORT (no framework changes)" />
  <Card title="Changelog" href="/docs/changelog" description="Release history, generated from main at release time" />
</Cards>
