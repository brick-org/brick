...
func TestF9_ResolveSendOnSignUp(t *testing.T) {
...
func TestF9_SendOnSignUpZeroValueIsUnset(t *testing.T) {
...
func TestF9_ResolveUpdateAgeSeconds(t *testing.T) {
...
func TestF9_UpdateAgeDuration(t *testing.T) {
...
func TestF9_UpdateAgeValidate(t *testing.T) {
	for _, tc := range []struct {
		name    string
