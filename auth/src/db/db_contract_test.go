...
func TestDBContract_OperatorVocabulary(t *testing.T) {
	upstream := []Operator{
		"eq", "ne", "lt", "lte", "gt", "gte",
...
func TestDBContract_NormalizeMatrix(t *testing.T) {
...
func TestDBContract_ValidateIdentifierMatrix(t *testing.T) {
...
func TestDBContract_JoinOptionGolden(t *testing.T) {
...
func TestDBContract_DBContractLimits(t *testing.T) {
...
func TestDBContract_DBContractConcurrentUse(t *testing.T) {
