...
func TestReserveConsume_VerificationReservationID_Deterministic(t *testing.T) {
...
func TestReserveConsume_DuplicateKeyError_Mapping(t *testing.T) {
	cases := []struct {
		name string
		msg  string
		want bool
...
func TestReserveConsume_ReserveVerificationValue_RoundTrip(t *testing.T) {
...
func TestReserveConsume_ReserveVerificationValue_MapsRealFailure(t *testing.T) {
	ctx := context.Background()
	expires := time.Now().UTC().Add(time.Hour)
...
func TestReserveConsume_ConsumeOneWithFallback_Atomic(t *testing.T) {
	ctx := context.Background()
	a := newF10FakeAdapter()
...
func TestReserveConsume_ConsumeOneWithFallback_UnsupportedFallsBack(t *testing.T) {
	ctx := context.Background()
	a := newF10FakeAdapter()
...
func TestReserveConsume_ConsumeOneWithFallback_PassthroughError(t *testing.T) {
	ctx := context.Background()
	a := newF10FakeAdapter()
