...
func TestHfixDeleteMissingRowSkipsHooksAndWrite(t *testing.T) {
...
func TestHfixDeletePreReadErrorFailsClosed(t *testing.T) {
	ctx := context.Background()
...
func TestHfixDeleteManyEmptySetFiresNoHooks(t *testing.T) {
	ctx := context.Background()
...
func TestHfixDeleteManyPreReadErrorLogsAndProceeds(t *testing.T) {
	ctx := context.Background()
...
func TestHfixUpdateManyAfterReceivesNilPayload(t *testing.T) {
	ctx := context.Background()
	inner := newHfixAdapter()
...
func TestHfixBeforeHookPartialMapMerges(t *testing.T) {
	ctx := context.Background()
	inner := newHfixAdapter()
...
func TestHfixAfterHooksDeferPostCommit(t *testing.T) {
	ctx := context.Background()
...
func TestHfixSilentAbortSkipsWrite(t *testing.T) {
	ctx := context.Background()
	inner := newMemoryAdapter()
	wrapped := auth.NewHookedAdapter(inner, nil, auth.DBHooks{
		"user": {
...
func TestHfixPluginSourceLabel(t *testing.T) {
	ctx := context.Background()
