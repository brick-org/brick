...
func TestF11_UpgradeHash_BcryptToScrypt(t *testing.T) {
...
func TestF11_UpgradeHash_WrongPasswordNoUpgrade(t *testing.T) {
	hash, err := bcrypt.GenerateFromPassword([]byte("legacy-password"), 4)
	if err != nil {
		t.Fatal(err)
	}
...
func TestF11_UpgradeHash_ScryptNoUpgrade(t *testing.T) {
...
func TestF11_UpgradeHash_MalformedNoUpgrade(t *testing.T) {
...
func TestF11_JWE_SingleSecretString(t *testing.T) {
...
func TestF11_JWE_SameConfig(t *testing.T) {
...
func TestF11_JWE_RotatedContainingOldKey(t *testing.T) {
...
func TestF11_JWE_KidLessFallbackTriesAllSecrets(t *testing.T) {
...
func TestF11_JWE_LegacyStringConfig(t *testing.T) {
...
func TestF11_JWE_MismatchedKidNoFallback(t *testing.T) {
...
func TestF11_ConstantTimeEqual_LengthMismatchFails(t *testing.T) {
...
func TestF11_ParseEnvelope_StrictRejectsPrefix(t *testing.T) {
