...
func TestC2_JWEHeaderExactAndKidPinned(t *testing.T) {
	wantKid := c2WantKid(t)
	for i := 0; i < 50; i++ {
...
func TestC2_JWERoundTripPayloadEqualityAndRandomness(t *testing.T) {
...
func TestC2_JWECrossStackCryptoToCookies(t *testing.T) {
...
func TestC2_JWECrossStackCookiesToCrypto(t *testing.T) {
	session, user := c2SessionUser()
