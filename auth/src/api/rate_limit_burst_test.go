...
func TestRateLimitBurst_MemoryBurstAllowsExactlyMax(t *testing.T) {
...
func TestRateLimitBurst_ConsumeResolvedBurstMemoryBackend(t *testing.T) {
	opts := enabledOptions()
...
func TestRateLimitBurst_MemoryWindowRollover(t *testing.T) {
	storage := MemoryRateLimitStorage{}
