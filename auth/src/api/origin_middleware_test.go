...
func TestOrigin_OriginRefererFallback_UntrustedRefererRejected(t *testing.T) {
...
func TestOrigin_OriginRefererFallback_TrustedRefererPasses(t *testing.T) {
	opts := f10OriginOptions("https://app.example")
	api := Router(humatest.NewAdapter(), "/api/auth", opts)
	resp := humatest.Wrap(t, api).Post("/api/auth/sign-out",
...
func TestOrigin_NullOrigin_SameOriginInferencePasses(t *testing.T) {
...
func TestOrigin_NullOrigin_WithoutInferenceRejected(t *testing.T) {
	opts := f10OriginOptions("https://app.example")
	api := Router(humatest.NewAdapter(), "/api/auth", opts)
	resp := humatest.Wrap(t, api).Post("/api/auth/sign-out",
		"Origin: null",
...
func TestOrigin_FormCsrf_CrossSiteNavigateBlocked(t *testing.T) {
	opts := f10OriginOptions("https://app.example")
	api := Router(humatest.NewAdapter(), "/api/auth", opts)
...
func TestOrigin_FormCsrf_CookieLessOriginForceValidated(t *testing.T) {
	opts := f10OriginOptions("https://app.example")
	api := Router(humatest.NewAdapter(), "/api/auth", opts)
	resp := humatest.Wrap(t, api).Post("/api/auth/sign-in/email",
...
func TestOrigin_FormCsrf_ServerToServerPasses(t *testing.T) {
	opts := f10OriginOptions("https://app.example")
	api := Router(humatest.NewAdapter(), "/api/auth", opts)
	resp := humatest.Wrap(t, api).Post("/api/auth/sign-out")
	if resp.Code == http.StatusForbidden {
...
func TestOrigin_SkipOriginCheckPaths_ArrayHonored(t *testing.T) {
	opts := f10OriginOptions("https://app.example")
...
func TestOrigin_SkipOriginCheckPaths_SlashBoundary(t *testing.T) {
	opts := f10OriginOptions("https://app.example")
...
func TestOrigin_SkipCSRFCheck_GranularityPinned(t *testing.T) {
	opts := f10OriginOptions("https://app.example")
...
func TestOrigin_TraceMethod_OriginValidated(t *testing.T) {
	opts := f10OriginOptions("https://app.example")
...
func TestOrigin_MemoryBackendBurst_AtomicConsume(t *testing.T) {
	rateLimitMu.Lock()
...
func TestOrigin_CustomRule_DoubleStarMatchesUpstream(t *testing.T) {
...
func TestOrigin_CustomResolver_DoubleStarMatchesUpstream(t *testing.T) {
...
func TestOrigin_PluginBucket_OnlyRulesConsume(t *testing.T) {
	rateLimitMu.Lock()
	original := rateLimitMemory
	rateLimitMemory = map[string]memoryRateLimitEntry{}
	rateLimitMu.Unlock()
