...
func TestRefreshCacheTable_StatefulWarnDisable(t *testing.T) {
...
func TestRefreshCacheTable_StatelessHonored(t *testing.T) {
...
func TestRefreshCacheTable_ExplicitUpdateAge(t *testing.T) {
...
func TestRefreshCacheTable_UnsetStaysOff(t *testing.T) {
