...
func TestAccount_ListAccounts(t *testing.T) {
...
func TestAccount_ListAccountsEmptyScope(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	api := credsAccountAPI(t, opts)
...
func TestAccount_UpdateUserKeepsStoredAdditional(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestAccount_UpdateUserUnsetsImage(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	api := credsAccountAPI(t, opts)
...
func TestAccount_UpdateUserInputFalseRejected(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	opts.User.Model.AdditionalFields = map[string]types.FieldAttribute{
...
func TestAccount_ChangePasswordWrongCurrent(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	api := credsAccountAPI(t, opts)
...
func TestAccount_ChangePasswordRevokesOthers(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	api := credsAccountAPI(t, opts)
...
func TestAccount_ChangeEmailExistingTarget(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestAccount_ChangeEmailSameErrorWithoutSender(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	opts.User.ChangeEmail.Enabled = true
	api := credsAccountAPI(t, opts)
...
func TestAccount_ChangeEmailCallbackEncoding(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	opts.EmailVerification.SendVerificationEmail = func(types.VerificationEmailData) error { return nil }
...
func TestAccount_ChangeEmailConfirmationOnlyConfig(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	opts.User.ChangeEmail.Enabled = true
...
func TestAccount_ChangeEmailKeepsCredentialAccount(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	opts.User.ChangeEmail.Enabled = true
...
func TestAccount_DeleteUserVerificationFlowWithPassword(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestAccount_DeleteUserRequiresPasswordWhenStale(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	opts.User.DeleteUser.Enabled = true
	staleAge := 1
...
func TestAccount_DeleteUserCallbackRevokedSession(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	opts.User.DeleteUser.Enabled = true
	var token string
...
func TestAccount_DeleteUserFreshSession(t *testing.T) {	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	opts.User.DeleteUser.Enabled = true
	freshAge := 1000
...
func TestAccount_DeleteUserCallbackUntrustedCallbackURL(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	opts.User.DeleteUser.Enabled = true
	var token string
...
func TestAccount_ChangeEmailDoubleConfirm(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
