...
func TestVerifyEmailNullUser_AlreadyVerifiedProcessReturnsNullUser(t *testing.T) {
...
func TestVerifyEmailNullUser_AlreadyVerifiedPostReturnsNullUser(t *testing.T) {
	db := newParityMemAdapter()
...
func TestVerifyEmailNullUser_AlreadyVerifiedGetReturnsNullUser(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestVerifyEmailNullUser_FreshVerifyReturnsNull(t *testing.T) {
	db := newParityMemAdapter()
	opts := parityTestOptions(db)
