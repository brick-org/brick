...
// TestSecondaryFanout_RefreshPropagatesAcrossSessions ports update-user.test.ts
func TestSecondaryFanout_RefreshPropagatesAcrossSessions(t *testing.T) {
...
// TestSecondaryFanout_RefreshWritesOncePerToken ports update-user.test.ts
func TestSecondaryFanout_RefreshWritesOncePerToken(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
...
func TestSecondaryFanout_RefreshSkipsStaleRefs(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	store := newMapSecondaryStorage(true)
	opts := secondarySessionTestOptions(db, store)
...
func TestSecondaryFanout_DeleteAllThenRecreateKeepsOnlyReplacement(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	store := newMapSecondaryStorage(true)
	opts := secondarySessionTestOptions(db, store)
...
// TestSecondaryFanout_RouteListRevokeSecondary ports the session-api.test.ts
func TestSecondaryFanout_RouteListRevokeSecondary(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	store := newMapSecondaryStorage(true)
	opts := secondarySessionTestOptions(db, store)
