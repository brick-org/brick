...
// transcode pattern.
func TestG2_SignInFormURLEncoded(t *testing.T) {
...
func TestG2_SignInFormValidationParity(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	api := g2SignInAPI(t, opts)
...
// string.
func TestG2_SignInEmailPasswordDisabledCode(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestG2_SignInBcryptHashRotatedToScrypt(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestG2_SignInCustomVerifySkipsRotation(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
