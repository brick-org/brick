...
// TestSignUpCredential_VerifyEmailConfirmationLeg/TestSignUpCredential_VerifyEmailVerificationLeg.
...
func TestVerificationSend_SendVerificationSenderAPIErrorPropagates(t *testing.T) {
...
func TestVerificationSend_SendVerificationMissingEmailFloor(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	var sent []string
...
func TestVerificationSend_SendVerificationDelivers(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestVerificationSend_SendVerificationSkipsVerifiedThirdParty(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	var calls int
	var token string
...
func TestVerificationSend_VerifyEmailGetRedirectsToCallback(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	var token string
	opts.EmailVerification.SendVerificationEmail = func(data types.VerificationEmailData) error {
...
func TestVerificationSend_VerifyEmailGetPreservesEncodedCallback(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	var token string
	opts.EmailVerification.SendVerificationEmail = func(data types.VerificationEmailData) error {
