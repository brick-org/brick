...
func TestOrphanV1_SessionCreateFailureRemovesUser(t *testing.T) {
...
func TestOrphanV1_SecondaryMirrorFailureRemovesUser(t *testing.T) {
...
func TestOrphanV1_SuccessKeepsRows(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	api := credsSignUpAPI(t, opts)
