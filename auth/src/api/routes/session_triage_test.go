...
func TestSessionTriage_ListSessionsPrimary(t *testing.T) {
...
func TestSessionTriage_RevokeOwnSessionThenRevokeAll(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
	...
	if resp := api.Get("/api/auth/get-session", "Cookie: "+cookieA); resp.Code != http.StatusOK || strings.TrimSpace(resp.Body.String()) != "null" {
	...
	if resp := api.Get("/api/auth/get-session", "Cookie: "+cookieB); resp.Code != http.StatusOK || strings.TrimSpace(resp.Body.String()) != "null" {
...
func TestSessionTriage_UpdateSessionCustomFieldAndCookie(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
...
func TestSessionTriage_UpdateSessionIgnoresCoreFields(t *testing.T) {
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
...
func TestSessionTriage_JWTCacheMaxAgeExpiry(t *testing.T) {
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
...
func TestSessionTriage_CompactExpiredCacheRefreshes(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
...
func TestSessionTriage_StatelessRefreshPreservesExpiry(t *testing.T) {
...
func TestSessionTriage_DeferPostWritesDueSession(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
...
func TestSessionTriage_ForcedStrictChangePassword(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
	opts.Session.CookieCache.Enabled = true
...
func TestSessionTriage_NoStoreAbsentElsewhere(t *testing.T) {
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
...
func TestSessionTriage_CacheServesAdditionalFields(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
	opts.Session.CookieCache.Enabled = true
