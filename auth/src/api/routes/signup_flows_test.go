...
func TestSignUp_SignUpAdditionalFields(t *testing.T) {
...
func TestSignUp_SignUpInputFalseRejected(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	opts.User.Model.AdditionalFields = map[string]types.FieldAttribute{
...
func TestSignUp_SignUpEmptyName(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	api := credsSignUpAPI(t, opts)
	resp := api.Post("/api/auth/sign-up/email", map[string]any{
...
func TestSignUp_SignUpMissingPasswordIsClientError(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	api := credsSignUpAPI(t, opts)
	resp := api.Post("/api/auth/sign-up/email", map[string]any{
...
func TestSignUp_SignUpVerificationURLEncoding(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestSignUp_SignUpDuplicateCaseInsensitive(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	api := credsSignUpAPI(t, opts)
...
func TestSignUp_SignUpShortPasswordWarns(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	var calls [][2]string
...
func TestSignUp_SyntheticResponseParity(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
