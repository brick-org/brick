...
func TestOutputFilter_ExcludeSingleUserField(t *testing.T) {
...
func TestOutputFilter_MultipleUserFields(t *testing.T) {
	ctx := context.Background()
	opts, _ := filterV1BaseOpts()
	opts.User.Model.AdditionalFields = map[string]types.FieldAttribute{
...
func TestOutputFilter_LargeFieldExcluded(t *testing.T) {
	ctx := context.Background()
	opts, _ := filterV1BaseOpts()
...
func TestOutputFilter_SessionFieldFiltering(t *testing.T) {
	ctx := context.Background()
	opts, _ := filterV1BaseOpts()
...
func TestOutputFilter_UnknownFieldsKept(t *testing.T) {
	ctx := context.Background()
	opts, _ := filterV1BaseOpts()
	opts.User.Model.AdditionalFields = map[string]types.FieldAttribute{
...
func TestOutputFilter_JWTStrategy(t *testing.T) {
	ctx := context.Background()
	opts, _ := filterV1BaseOpts()
...
func TestOutputFilter_CompactStrategy(t *testing.T) {
	ctx := context.Background()
	opts, _ := filterV1BaseOpts()
...
func TestOutputFilter_CustomSignerFiltering(t *testing.T) {
	ctx := context.Background()
	opts, _ := filterV1BaseOpts()
	opts.Session.CookieCache.Strategy = types.SessionCookieCacheJWT
	opts.User.Model.AdditionalFields = map[string]types.FieldAttribute{
