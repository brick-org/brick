...
func TestSecondaryWiring_UpdateUserPropagatesToSecondarySessions(t *testing.T) {
...
func TestSecondaryWiring_UpdateUserSecondaryFailureIsLoud(t *testing.T) {
	db := newParityMemAdapter()
...
func TestSecondaryWiring_ChangePasswordClearsSecondarySessions(t *testing.T) {
...
func TestSecondaryWiring_VerifyEmailFlipsSecondarySessions(t *testing.T) {
	db := newParityMemAdapter()
	store := newMapSecondaryStorage(true)
	opts := emailAuthTestOptions(db)
	opts.SecondaryStorage = store
...
func TestSecondaryWiring_VerifyEmailHookAPIErrorPropagates(t *testing.T) {
...
func TestSecondaryWiring_DeleteUserHookAPIErrorPropagates(t *testing.T) {
	boot := func(t *testing.T, mutate func(*types.Options)) (humatest.TestAPI, string) {
		t.Helper()
		db := newParityMemAdapter()
		opts := emailAuthTestOptions(db)
