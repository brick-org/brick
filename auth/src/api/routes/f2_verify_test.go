...
func TestF2_FreshPlainVerifyReturnsNull(t *testing.T) {
...
func TestF2_UpdateToReusesPreUpdateToken(t *testing.T) {
	db := newParityMemAdapter()
	opts := parityTestOptions(db)
...
func TestF2_FanOutFailureStillSucceeds(t *testing.T) {
	db := newParityMemAdapter()
