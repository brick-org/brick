...
func TestCredentialTriage_SignUpValidateUserInfoAllows(t *testing.T) {
...
func TestCredentialTriage_SignUpAutoSignInFalseTokenNull(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestCredentialTriage_SignUpSendOnSignUpTrue(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestCredentialTriage_SignUpSendOnSignUpDefault(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	opts.EmailAndPassword.RequireEmailVerification = true
	var calls int
...
func TestCredentialTriage_SignUpExistingHookSkippedWhenInactive(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	var calls int
...
func TestCredentialTriage_SignUpExistingHookSkippedForNewUser(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	opts.EmailAndPassword.RequireEmailVerification = true
	var calls int
...
func TestCredentialTriage_SignInSetsSessionCookie(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	api := triageCredsAPI(t, opts)
...
func TestCredentialTriage_SignInNoResendWhenDisabled(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	opts.EmailAndPassword.RequireEmailVerification = true
...
func TestCredentialTriage_ChangePasswordSuccessRotatesCredentials(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	api := triageCredsAPI(t, opts)
...
func TestCredentialTriage_ChangePasswordBumpsAccountUpdatedAt(t *testing.T) {
...
func TestCredentialTriage_DeleteUserDisabledIs404(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	api := triageCredsAPI(t, opts)
...
func TestCredentialTriage_ChangePasswordIgnoresCookieCache(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestCredentialTriage_ResetShortPasswordRejected(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	var token string
...
func TestCredentialTriage_ResetEmailCarriesLongToken(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestCredentialTriage_ResetBumpsAccountUpdatedAt(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	opts.TrustedOrigins = []string{"http://localhost:3000"}
...
func TestCredentialTriage_ResetExpiredTokenRejected(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	var token string
...
func TestCredentialTriage_ResetRevokesSessionsWhenEnabled(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestCredentialTriage_ResetKeepsSessionsByDefault(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	var token string
	opts.EmailAndPassword.SendResetPassword = func(data types.ResetPasswordData) error {
...
func TestCredentialTriage_VerifyEmailAutoSignInMintsSession(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestCredentialTriage_VerifyEmailExpiredTokenRejected(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestCredentialTriage_VerifyEmailAfterHookFires(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	var got *types.User
	var calls int
...
func TestCredentialTriage_VerifyEmailBeforeHookFires(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	var got string
	var calls int
...
func TestCredentialTriage_SendVerificationCallbackEncoding(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestCredentialTriage_SendVerificationSignedInCaseInsensitive(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	var sentTo string
	var calls int
