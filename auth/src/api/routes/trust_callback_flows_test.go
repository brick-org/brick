...
func TestTrustCallback_ChangeEmailUntrustedCallbackURL(t *testing.T) {
...
func TestTrustCallback_DeleteUserUntrustedCallbackURL(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestTrustCallback_ResetCallbackUntrustedCallbackURL(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
