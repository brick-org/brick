...
func TestSetPassword_SetPasswordOnPasswordlessAccount(t *testing.T) {
...
func TestSetPassword_SetPasswordAlreadySet(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestSetPassword_SetPasswordTooShort(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	var calls [][2]string
...
func TestSetPassword_SetPasswordCreatesMissingAccount(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
