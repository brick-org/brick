...
func TestVerifyEmailResend_ChangeEmailConfirmationResendEscapes(t *testing.T) {
...
func TestVerifyEmailResend_ChangeEmailLegacyResendEscapes(t *testing.T) {
	db := newParityMemAdapter()
	opts := parityTestOptions(db)
	opts.BasePath = "/api/auth"
	var gotURL, gotToken string
...
func TestVerifyEmailResend_AutoSignInReusesMatchingSession(t *testing.T) {
	db := newParityMemAdapter()
	opts := parityTestOptions(db)
	opts.BasePath = "/api/auth"
...
func TestVerifyEmailResend_AutoSignInMintsOnMismatch(t *testing.T) {
	db := newParityMemAdapter()
	opts := parityTestOptions(db)
	opts.BasePath = "/api/auth"
	opts.EmailVerification.AutoSignInAfterVerification = true
