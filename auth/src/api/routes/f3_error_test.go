...
func TestF3ErrorPageDefaultSnapshot(t *testing.T) {
...
func TestF3ErrorPageCustomDescriptionSnapshot(t *testing.T) {
	api := newF3ErrorTestAPI(t, types.Options{})
...
func TestF3ErrorPageXSSDescriptionRegression(t *testing.T) {
	api := newF3ErrorTestAPI(t, types.Options{})
...
func TestF3ErrorPageXSSCodeRegression(t *testing.T) {
	api := newF3ErrorTestAPI(t, types.Options{})
