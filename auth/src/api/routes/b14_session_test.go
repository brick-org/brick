...
func TestB14_GetSessionMissingTokenReturns200Null(t *testing.T) {
...
func TestB14_GetSessionUnknownTokenReturns200Null(t *testing.T) {
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
	_, api := humatest.New(t, huma.DefaultConfig("Test", "1.0.0"))
	GetSession(api, "/api/auth", opts)
...
func TestB14_GetSessionExpiredReturns200Null(t *testing.T) {
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
...
func TestB14_GetSessionValidStillServes(t *testing.T) {
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
...
func TestB14_GetSessionPostUnknownTokenReturns200Null(t *testing.T) {
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
...
func TestB14_CookieCacheVersionFuncFailure500s(t *testing.T) {
