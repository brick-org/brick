...
func TestF5_GetSessionNullLiteral(t *testing.T) {
...
func TestF5_UserMissingReturnsNull(t *testing.T) {
...
func TestF5_CompactInteropRead(t *testing.T) {
	ctx := context.Background()
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
...
func TestF5_CompactInteropWrite(t *testing.T) {
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
	opts.Session.CookieCache.Enabled = true
...
func TestF5_DontRememberExpiredOnExpiry(t *testing.T) {
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
