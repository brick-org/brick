...
func TestUntrustedCallback_SignInUntrustedCallback403(t *testing.T) {
...
func TestUntrustedCallback_SignUpUntrustedCallback403(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	api := credsSignUpAPI(t, opts)
...
func TestUntrustedCallback_SignUpDisabledCode(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestUntrustedCallback_SyntheticScopeOnlyUserAdditionalFields(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
...
func TestUntrustedCallback_SignUpMintEvenWithoutSender(t *testing.T) {
	db := newParityMemAdapter()
	opts := emailAuthTestOptions(db)
	opts.Secret = ""
	opts.Secrets = nil
