...
func TestUpdateSessionFields_UpdateSessionUnknownOnly400(t *testing.T) {
...
func TestUpdateSessionFields_UpdateSessionDeclaredAdditionalPasses(t *testing.T) {
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
...
func TestUpdateSessionFields_UpdateSessionEmpty400(t *testing.T) {
	db := newParityMemAdapter()
	opts := sessionTestOptions(db)
