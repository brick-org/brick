...
func TestG6_PostVerifyPreservesRealRequest(t *testing.T) {
...
func TestG6_PostVerifyPreservesHeadersWhenInputEmpty(t *testing.T) {
	realReq, _ := http.NewRequest(http.MethodPost, "https://example.com/api/auth/verify-email", nil)
	realReq.Host = "example.com"
...
func TestG6_ChangeEmailVerificationReusesMatchingSession(t *testing.T) {
...
func TestG6_ChangeEmailVerificationMintsOnMismatch(t *testing.T) {
	db := newParityMemAdapter()
	opts := parityTestOptions(db)
	opts.BasePath = "/api/auth"
...
func TestG6_LegacyUpdateToReusesMatchingSession(t *testing.T) {
	db := newParityMemAdapter()
	opts := parityTestOptions(db)
	opts.BasePath = "/api/auth"
...
func TestG6_LegacyUpdateToMintsOnMismatch(t *testing.T) {
	db := newParityMemAdapter()
	opts := parityTestOptions(db)
	opts.BasePath = "/api/auth"
