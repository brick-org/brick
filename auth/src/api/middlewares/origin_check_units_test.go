...
func TestOriginCheck_IsMutatingMethod_MatchesUpstreamNotGetOptionsHead(t *testing.T) {
	cases := []struct {
		method string
		want   bool
	}{
...
func TestOriginCheck_OriginOrReferer_PrefersOriginFallsBack(t *testing.T) {
...
func TestOriginCheck_ShouldSkipOriginCheck_SlashBoundary(t *testing.T) {
...
func TestOriginCheck_ResolveOriginCandidate_NullInference(t *testing.T) {
...
func TestOriginCheck_FetchMetadataRouting(t *testing.T) {
...
func TestOriginCheck_NeedsOriginValidation_EvidenceGate(t *testing.T) {
