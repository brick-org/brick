...
func TestOriginLegs_SignOut_CookieLessBareOriginPasses(t *testing.T) {
...
func TestOriginLegs_OtherRoute_CookieLessBareOriginPasses(t *testing.T) {
	opts := g10OriginOptions("https://app.example")
	api := Router(humatest.NewAdapter(), "/api/auth", opts)
...
func TestOriginLegs_SignOut_CrossSiteNavigatePasses(t *testing.T) {
	opts := g10OriginOptions("https://app.example")
	api := Router(humatest.NewAdapter(), "/api/auth", opts)
	resp := humatest.Wrap(t, api).Post("/api/auth/sign-out",
...
func TestOriginLegs_SignIn_CrossSiteNavigateBlocked(t *testing.T) {
	opts := g10OriginOptions("https://app.example")
	api := Router(humatest.NewAdapter(), "/api/auth", opts)
...
func TestOriginLegs_SignUp_CrossSiteNavigateBlocked(t *testing.T) {
	opts := g10OriginOptions("https://app.example")
	api := Router(humatest.NewAdapter(), "/api/auth", opts)
...
func TestOriginLegs_SignIn_CookieLessUntrustedOriginBlocked(t *testing.T) {
	opts := g10OriginOptions("https://app.example")
	api := Router(humatest.NewAdapter(), "/api/auth", opts)
	resp := humatest.Wrap(t, api).Post("/api/auth/sign-in/email",
		"Origin: https://evil.example",
...
func TestOriginLegs_SignUp_CookieLessUntrustedOriginBlocked(t *testing.T) {
	opts := g10OriginOptions("https://app.example")
	api := Router(humatest.NewAdapter(), "/api/auth", opts)
	resp := humatest.Wrap(t, api).Post("/api/auth/sign-up/email",
		"Origin: https://evil.example",
