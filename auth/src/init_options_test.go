...
func TestInitDefuBaseWinsOnConflict(t *testing.T) {
	adapter, _ := newTestAdapter(t)
	a := mustBetterAuth(t, auth.Options{
		Secret:  f6Secret,
		Adapter: adapter,
...
func TestInitDefuNestedStructMerge(t *testing.T) {
	adapter, _ := newTestAdapter(t)
	a := mustBetterAuth(t, auth.Options{
		Secret:  f6Secret,
		Adapter: adapter,
...
func TestInitDefuSliceConcatBaseFirst(t *testing.T) {
	adapter, _ := newTestAdapter(t)
	a := mustBetterAuth(t, auth.Options{
		Secret:          f6Secret,
		Adapter:         adapter,
...
func TestInitContextPatchOverwriteOrder(t *testing.T) {
	adapter, _ := newTestAdapter(t)
...
func TestInitContextPatchSecretOrder(t *testing.T) {
	adapter, _ := newTestAdapter(t)
	a := mustBetterAuth(t, auth.Options{
		Secret:  f6Secret,
		Adapter: adapter,
...
func TestInitTrustedOriginComposition(t *testing.T) {
	adapter, _ := newTestAdapter(t)
	a := mustBetterAuth(t, auth.Options{
		Secret:         f6Secret,
		Adapter:        adapter,
...
func TestInitParseSecretsEnvValid(t *testing.T) {
...
func TestInitParseSecretsEnvFailures(t *testing.T) {
...
func TestInitValidateSecretsArrayWarnings(t *testing.T) {
	var warnings []string
...
func TestInitSecretPrecedence(t *testing.T) {
	adapter, _ := newTestAdapter(t)
...
func TestInitDefaultSecretProduction(t *testing.T) {
...
func TestInitLegacyShortSecretWarning(t *testing.T) {
	t.Setenv("BETTER_AUTH_SECRET", "")
	t.Setenv("AUTH_SECRET", "")
	t.Setenv("BETTER_AUTH_SECRETS", "")
...
func TestInitVersionedRotation(t *testing.T) {
	adapter, _ := newTestAdapter(t)
	a := mustBetterAuth(t, auth.Options{
...
func TestInitRotationDuplicateVersionsFail(t *testing.T) {
	adapter, _ := newTestAdapter(t)
...
func TestInitTelemetryDisabledSilent(t *testing.T) {
...
func TestInitTelemetryNonDebugHidesPayload(t *testing.T) {
	t.Setenv("BETTER_AUTH_TELEMETRY", "")
	t.Setenv("BETTER_AUTH_TELEMETRY_DEBUG", "")
	got, logger := f6CaptureLogger(types.LogLevelDebug)
	adapter, _ := newTestAdapter(t)
...
func TestInitTelemetryInitDiagnostic(t *testing.T) {
	t.Setenv("BETTER_AUTH_TELEMETRY", "")
	t.Setenv("BETTER_AUTH_TELEMETRY_DEBUG", "")
	got, logger := f6CaptureLogger(types.LogLevelDebug)
	adapter, _ := newTestAdapter(t)
...
func TestInitWithSpanPassthrough(t *testing.T) {
	adapter, _ := newTestAdapter(t)
...
func TestInitAppNameDefaults(t *testing.T) {
	adapter, _ := newTestAdapter(t)
	a := mustBetterAuth(t, auth.Options{Secret: f6Secret, Adapter: adapter})
