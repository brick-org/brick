...
func TestHookedLifecycleBeforeHookPartialMapMerges(t *testing.T) {
...
func TestHookedLifecycleUpdateManyAfterBulkReceivesCount(t *testing.T) {
	ctx := context.Background()
	inner := newHfixAdapter()
...
func TestHookedLifecyclePostCommitAfterErrorPropagates(t *testing.T) {
	ctx := context.Background()
...
func TestHookedLifecyclePostCommitErrorHandlerSwallows(t *testing.T) {
	ctx := context.Background()
	inner := newMemoryAdapter()
	hookErr := errors.New("post-commit after failed")
	var handled []error
...
func TestHookedLifecyclePostCommitHandlerRunsLaterHooks(t *testing.T) {
	ctx := context.Background()
	inner := newMemoryAdapter()
...
func TestHookedLifecyclePostCommitWithoutHandlerStopsAtFirstError(t *testing.T) {
	ctx := context.Background()
	inner := newMemoryAdapter()
	firstErr := errors.New("first after failed")
	var secondRan bool
...
func TestHookedLifecycleAdapterOverrideReplacesInnerCreate(t *testing.T) {
	ctx := context.Background()
	inner := newHfixAdapter()
	called := false
...
func TestHookedLifecycleAdapterOverrideTypeMismatchFailsClosed(t *testing.T) {
	ctx := context.Background()
	inner := newHfixAdapter()
	wrapped := auth.NewHookedAdapterWithOptions(inner, nil, nil, auth.HookedAdapterOptions{
		Overrides: types.PluginAdapterOverrides{
...
func TestHookedLifecycleFieldValidatorRejectsWrite(t *testing.T) {
	ctx := context.Background()
	inner := newMemoryAdapter()
...
func TestHookedLifecycleFieldTransformInputOutput(t *testing.T) {
	ctx := context.Background()
	inner := newMemoryAdapter()
