...
// TestVector_RedirectVectors asserts every shared redirect-trust vector against trusted-origins.ts.
func TestVector_RedirectVectors(t *testing.T) {
	var doc struct {
...
// TestVector_RegistrationVectors pins the fixture shape contract and the fail-closed core.
func TestVector_RegistrationVectors(t *testing.T) {
	var doc struct {
		Cases []struct {
			Name     string `json:"name"`
			URI      string `json:"uri"`
