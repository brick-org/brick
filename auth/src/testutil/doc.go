...
// auth/testdata and verifies them against the Go helpers in both
...
// generation command) lives in auth/testdata/provenance.json and is
// summarized in auth/testdata/README.md (AUTH-R5-04).
package testutil
