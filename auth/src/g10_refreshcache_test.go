...
func TestG10_RefreshCacheConstruction_StatelessKeepsEnabled(t *testing.T) {
	api := newTestAPI(t)
	var logs []string
...
func TestG10_RefreshCacheConstruction_StatefulDBWarnDisable(t *testing.T) {
	api := newTestAPI(t)
	var logs []string
	a, err := auth.BetterAuth(auth.Options{
		Secret:  "test-secret",
...
func TestG10_RefreshCacheConstruction_StatefulSecondaryWarnDisable(t *testing.T) {
	api := newTestAPI(t)
	var logs []string
	a, err := auth.BetterAuth(auth.Options{
		Secret:           "test-secret",
...
func TestG10_RefreshCacheConstruction_UnsetStaysQuiet(t *testing.T) {
	api := newTestAPI(t)
	var logs []string
	a, err := auth.BetterAuth(auth.Options{
		Secret:  "test-secret",
